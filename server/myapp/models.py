...
class Thing(models.Model):
    ...
    zlfs = models.CharField(max_length=50, blank=True, null=True)
    chaoxiang = models.CharField(max_length=50, blank=True, null=True)
    louceng = models.CharField(max_length=50, blank=True, null=True)
    mianji = models.CharField(max_length=50, blank=True, null=True)
    xiaoqu = models.CharField(max_length=50, blank=True, null=True)
    yajin = models.CharField(max_length=50, blank=True, null=True)
